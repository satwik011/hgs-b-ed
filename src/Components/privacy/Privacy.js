    ...
    <div className="home_main" onScroll={handleScroll}>
      ...
      <div style={{ padding: "1% 5%" }}>
        <p style={{ fontWeight: "bold" }}>
          Privacy Policy for Hermann Gmeiner Schools
        </p>
        ...
        <h1 style={{ color: "#17365D", borderBottom: "1px solid black" }}>
          Interpretation and Definitions
        </h1>
        <h2 style={{ color: "#4F81BD" }}>Interpretation</h2>
        <p>
        ...
        <h2 style={{ color: "#4F81BD" }}>Definitions</h2>
        ...
        <ul>
          ...
          <p>
            ...
            refers to SOS Children&apos;s Villages of India, A-7, Nizamuddin West,
            New Delhi - 110013.
          </p>
          <p>
          ...
          <p>Country&nbsp;refers to: Delhi, India</p>
          <p>
          ...
          <p>
            Website&nbsp;refers to J.N. Kaul Institute of Education, accessible
            from&nbsp;
            <a href="https://jnkinstituteofeducation.org">
              https://jnkinstituteofeducation.org
            </a>
          </p>
          <p>
        ...
        <h2 style={{ color: "#4F81BD" }}>Types of Data Collected</h2>
        <h5 style={{ color: "#4F81BD" }}>Personal Data</h5>
        <p>
        ...
        <p>Usage Data</p>
        <h5 style={{ color: "#4F81BD" }}>Usage Data</h5>
        ...
        <h5 style={{ color: "#4F81BD" }}>Tracking Technologies and Cookies</h5>
        <p>
        ...
        <p style={{ fontWeight: "bold" }}>Necessary / Essential Cookies</p>
        ...
        <p style={{ fontWeight: "bold" }}>Functionality Cookies</p>
        <p>Type: Persistent Cookies</p>
        <p>Administered by: Us</p>
        <p>
        ...
        <h2 style={{ color: "#4F81BD" }}>Use of Your Personal Data</h2>
        ...
        <h2 style={{ color: "#4F81BD" }}>Retention of Your Personal Data</h2>
        <p>
        ...
        <h2 style={{ color: "#4F81BD" }}>Transfer of Your Personal Data</h2>
        <p>
        ...
        <h2 style={{ color: "#4F81BD" }}>Delete Your Personal Data</h2>
        <p>
        ...
        <h2 style={{ color: "#4F81BD" }}>Disclosure of Your Personal Data</h2>
        <h3 style={{ color: "#4F81BD" }}>Business Transactions</h3>
        <p>
        ...
        <h3 style={{ color: "#4F81BD" }}>Law enforcement</h3>
        <p>
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h3 style={{ color: "#4F81BD" }}>Other legal requirements</h3>
        <p>
        ...
        <h2 style={{ color: "#4F81BD" }}>Security of Your Personal Data</h2>
        <p>
        ...
        <ul>
          <li>
            <p>By email: hgs.info@soscvindia.org</p>
          </li>
        </ul>
      </div>
      <Footer />
